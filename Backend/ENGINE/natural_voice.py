...
def get_proxies(filename: str = filename, number_of_proxies: int = 300, prints: bool = False) -> None:
    """
...
def download_audio_speech(extracted_url_: str, prints: bool = False) -> str:
    ...
    file_name = "Data/" + os.path.basename(extracted_url_)
...
def get_proxies_periodic(periodic_time: int = 20) -> None:
    """
